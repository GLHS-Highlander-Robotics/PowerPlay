...
public final class LogFiles {
    ...
    public static class LogFile {
        ...
        public double mecTransP = StrafeDrive.TRANSLATIONAL_PID.kP;
        public double mecTransI = StrafeDrive.TRANSLATIONAL_PID.kI;
        public double mecTransD = StrafeDrive.TRANSLATIONAL_PID.kD;
        public double mecHeadingP = StrafeDrive.HEADING_PID.kP;
        public double mecHeadingI = StrafeDrive.HEADING_PID.kI;
        public double mecHeadingD = StrafeDrive.HEADING_PID.kD;
        public double mecLateralMultiplier = StrafeDrive.LATERAL_MULTIPLIER;
